...
export function llmsTxt(): string {
  return [
    ...
    '',
    'This site is a single-page profile plus two legal pages. The profile is',
    'mirrored as plain Markdown; the two legal pages are HTML only, so the binding',
    'legal text keeps exactly one authoritative wording. No JavaScript is required',
    'to read any of it.',
    '',
    '## Pages',
    '',
